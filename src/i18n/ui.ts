...
export const ui = {
    en: {
        ...
        'code_line': 'Ibn jettison a container into the space while Vindicator’s weapons aligns towards you. The container is prompting you for THE CODE. It’s your time to hack the container or lose your implants.',
        'the_code': 'THE CODE',
        ...
        'about_text': 'Minmatar Fleet Alliance is a PVP Alliance with strong connections to Faction Warfare. We are the primary source of public militia fleets, and the number one trade supplier for the Minmatar War effort. More information at [my.minmatar.org](https://my.minmatar.org/).',
